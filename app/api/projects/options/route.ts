...
// Status and Area properties. Used by the Projects table to colour badges
// from live Notion data rather than hardcoded enum-based colours.
//
...
export async function GET() {
  try {
    const [status, area] = await Promise.all([
      fetchSelectOptions("Status"),
      fetchSelectOptions("Area"),
    ]);
